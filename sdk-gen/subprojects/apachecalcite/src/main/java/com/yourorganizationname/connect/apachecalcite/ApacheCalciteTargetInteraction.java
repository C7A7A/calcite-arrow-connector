...
public class ApacheCalciteTargetInteraction extends RowBasedTargetInteraction<ApacheCalciteConnector>
{
    protected ApacheCalciteTargetInteraction(ApacheCalciteConnector connector, CustomFlightAssetDescriptor asset)
    {
        super();
