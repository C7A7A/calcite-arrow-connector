...
public class ApacheCalciteSourceInteraction extends RowBasedSourceInteraction<ApacheCalciteConnector>
{
    protected ApacheCalciteSourceInteraction(ApacheCalciteConnector connector, CustomFlightAssetDescriptor asset)
    {
        super();
