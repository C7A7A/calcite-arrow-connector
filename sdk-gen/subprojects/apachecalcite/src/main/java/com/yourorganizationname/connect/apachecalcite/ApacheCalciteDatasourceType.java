...
public class ApacheCalciteDatasourceType extends CustomFlightDatasourceType
{
    /**
     * An instance of the custom Apache Derby data source type.
     */
    public static final ApacheCalciteDatasourceType INSTANCE = new ApacheCalciteDatasourceType();

    /**
     * The unique identifier name of the data source type.
     */
    public static final String DATASOURCE_TYPE_NAME = "apachecalcite";
    private static final String DATASOURCE_TYPE_LABEL = "ApacheCalcite";
    private static final String DATASOURCE_TYPE_DESCRIPTION = "ApacheCalcite (SDK)";

    public ApacheCalciteDatasourceType()
    {
        super();
